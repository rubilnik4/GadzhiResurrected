...
using static GadzhiResurrected.Infrastructure.Implementations.Converters.StatusProcessingProjectConverter;

namespace GadzhiResurrected.Infrastructure.Implementations
{
    /// <summary>

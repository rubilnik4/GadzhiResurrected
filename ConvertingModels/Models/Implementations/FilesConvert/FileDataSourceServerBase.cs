...
namespace ConvertingModels.Models.Implementations.FilesConvert
{
    ...
    /// </summary>
    public abstract class FileDataSourceServerBase: IFileDataSourceServer
    {       
        public FileDataSourceServerBase(string filePath, FileExtention fileExtensionType, string paperSize, string printerName)
        {
